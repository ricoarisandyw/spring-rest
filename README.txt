...
application.  The project object com.ricoaw.model (pom) is defined in the file pom.xml.
The application is ready to run as a web application. The pom.xml file is
pre-defined with Hibernate as a persistence com.ricoaw.model and Spring MVC as the web
framework.
